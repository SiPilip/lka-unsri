...
const LoginPage: React.FC<LoginPageProps> = ({ onSwitchToSignUp }) => {
  ...
  const handleForgotPassword = () => {
    alert('Fitur "Lupa Password" sedang dalam pengembangan. Silakan hubungi bagian akademik untuk bantuan.');
  };
    ...
    <div className="flex items-center justify-center min-h-full p-4">
      <div className="w-full max-w-sm p-8 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
        <div className="text-center space-y-2">
            ...
            <p className="pt-4 text-sm text-gray-600 dark:text-gray-400">Silakan masuk untuk memulai sesi Anda.</p>
        </div>
        ...
        <div className="flex justify-center p-1 bg-gray-200 dark:bg-gray-700 rounded-lg">
            <button
                ...
                disabled={isLoading}
                className={`w-1/2 px-4 py-2 text-sm font-semibold rounded-md transition-colors disabled:opacity-50 ${role === 'student' ? 'bg-white dark:bg-gray-900 text-primary dark:text-blue-300 shadow' : 'text-gray-600 dark:text-gray-400'}`}
            >
                Mahasiswa
            </button>
            <button
                ...
                disabled={isLoading}
                className={`w-1/2 px-4 py-2 text-sm font-semibold rounded-md transition-colors disabled:opacity-50 ${role === 'lecturer' ? 'bg-white dark:bg-gray-900 text-primary dark:text-blue-300 shadow' : 'text-gray-600 dark:text-gray-400'}`}
            >
                Dosen
            </button>
        </div>
          ...
          <div>
            <div className="relative">
                ...
                <input
                    ...
                    placeholder={role === 'student' ? "Email (@student.unsri.ac.id)" : "Email Dosen"}
